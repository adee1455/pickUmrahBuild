...
export default function Page({tourName, tourAddr, stars, reviews, departDate, arrivalDate, location, linethrough, days,twoShare,threeShare,fourShare,childBed, infant,makkahHotel, madinahHotel, makkahHotelstars, madinahHotelstars, makkahPic, madinahPic, makkahDist, madinahDist, makkahMap, madinahMap}) {
    ...
    (<div className="max-w-8xl lg:mx-20 md:mx-10 mx-3  md:py-12 py-5 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="lg:grid lg:grid-cols-3 ">
        <div className="md:col-span-2 col-span-3 max-w-8xl">
          <h1 className="md:text-4xl text-[26px] font-bold text-black">{tourName}</h1>
          <p className="md:text-md text-sm md:w-full w-64 text-gray-500">
            {tourAddr}, Maharashtra, India <span className="text-yellow-600 md:pl-5 pl-1">★ {stars}</span> · {reviews} reviews
          </p>
          <div className="mt-6 max-w-3xl flex lg:flex-row md:flex-row flex-row md:justify-around   items-center font-semibold space-x-2">
            <div className="">
                <Button className="bg-black text-white">{days} Days</Button>
            </div>
          <div className="flex md:flex-row  flex-col md:text-lg md:pl-3 pl-4 text-xs md:space-x-4">
            <div className="flex items-center flex-row  space-x-2">
              ...
              <span className="pl-3 w-full">{departDate}</span>  
              </div>
              <span className="px-0">|</span> 
              <div className="flex items-center ">
              <PlaneTakeoffIcon className="text-gray-600 ml-2" />
              <span className="pl-3 w-full">{arrivalDate}</span>
              </div>
            </div>

            <div className="  ">
                <p className="md:text-lg text-sm md:pl-3">Departure Location: {location}</p>
            </div>
          </div>
          </div>
      ...
      <div className="w-full">
        <Hotels
         ...
         makkahPic={makkahPic}
         madinahPic={madinahPic}
         makkahDist={makkahDist}
         madinahDist={madinahDist}
         makkahMap={makkahMap}
         madinahMap={madinahMap}
        />
      </div>

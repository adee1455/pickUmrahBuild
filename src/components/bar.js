...
export default function Bar() {
  ...
  return (
    <div className="max-w-4xl mx-auto border rounded-md border-black justify-between items-center dark:bg-white bg-white  shadow-lg p-2 flex">
      <Select className="flex-1  ">
        <SelectTrigger id="location" className="text-black w-1/4  ">
